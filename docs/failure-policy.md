...
| `panic` | User `Job.Run` / `ValueJob.Run` panicked; worker recovered (`ErrJobPanicked`); classified as `FailurePanic` — see [runtime-lifecycle-hardening.md](runtime-lifecycle-hardening.md) |
